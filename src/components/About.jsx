...
const About = () => {
  return (
    <>
      ...
      >
        I am an adept software developer proficient in Solidity, Python and
        JavaScript, with extensive knowledge of frameworks such as React,
        Node.js, and Three.js, EVM and blockchain. I possess the ability to
